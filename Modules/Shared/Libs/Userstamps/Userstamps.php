...
namespace Modules\Shared\Libs\Userstamps;
...
trait Userstamps
{
    ...
    {
        static::creating('Modules\Shared\Libs\Userstamps\Listeners\Creating@handle');
        static::updating('Modules\Shared\Libs\Userstamps\Listeners\Updating@handle');

        if (static::usingSoftDeletes()) {
            static::deleting('Modules\Shared\Libs\Userstamps\Listeners\Deleting@handle');
            static::restoring('Modules\Shared\Libs\Userstamps\Listeners\Restoring@handle');
        }
    }
    ...
    {
        return defined('static::CREATED_BY') ? static::CREATED_BY : 'created_by_id';
    }
    ...
    {
        return defined('static::UPDATED_BY') ? static::UPDATED_BY : 'updated_by_id';
    }
    ...
    {
        return defined('static::DELETED_BY') ? static::DELETED_BY : 'deleted_by_id';
    }
